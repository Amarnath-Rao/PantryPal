...
# Initialize Flagsmith client with your environment key
flagsmith_client = flagsmith.Client("<YOUR_ENVIRONMENT_KEY>")

with st.spinner("Setting up the application... Please wait :)"):
    from models import visionmodels, textmodels

#TODO: Setting Globally is okay? I don't even know anymore lol
